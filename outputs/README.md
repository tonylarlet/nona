...
Si tu ne veux pas utiliser `npm`, tu peux aussi lancer:
...
- `GET /` -> la page `index.html`
- `GET /notes-assistant.html` -> l'application
- `GET /companies.json` -> la liste des sociétés
- `POST /api/analyze` -> analyse IA via OpenAI
